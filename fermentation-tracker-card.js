        ...
        <div class="card-content">
          <div class="primary-metrics">
            <div class="metric gravity">
              ...
              ${void 0!==o?z`<span class="metric-secondary">${o}</span>`:V}
            </div>
          ...
          ${this._config.show_device_info?z`
                <div class="secondary-metrics">
                  ...
                  <div class="metric">
                    ...
                    <span class="metric-value">
                      ${void 0===w||isNaN(w)?"—":`${w.toFixed(2)} ${C}`}
                    </span>
                    ${this._renderDelta(S,2,"neutral",` ${C}`)}
                  </div>
                </div>
              `:V}

          ${!1!==this._config.show_graph?"apex"!==this._config.chart_type||customElements.get("apexcharts-card")?z`
                  ${this._historyCard?z`<div class="graph-wrapper">${this._historyCard}</div>`:V}
                  ${this._deviceInfoCard?z`<div class="graph-wrapper">${this._deviceInfoCard}</div>`:V}

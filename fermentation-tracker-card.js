        ...
        <div class="card-content">
          <div class="primary-metrics">
            <div class="metric gravity">
              ...
              ${void 0!==c?F`<span class="metric-secondary">${c}</span>`:G}
            </div>
          ...
          ${!1!==this._config.show_graph?"apex"!==this._config.chart_type||customElements.get("apexcharts-card")?this._historyCard?F`<div class="graph-wrapper">${this._historyCard}</div>`:G:F`<div class="graph-missing">

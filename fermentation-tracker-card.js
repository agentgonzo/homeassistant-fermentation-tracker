          ...
          ${this._config.show_device_info?z`
                <div class="secondary-metrics">
                  ...
                  <div class="metric">
                    ...
                    <span class="metric-value">
                      ${void 0===w||isNaN(w)?"—":`${w.toFixed(2)} ${S}`}
                    </span>
                    ${this._renderDelta(x,2,"neutral",` ${S}`)}
                  </div>
                </div>
              `:V}
